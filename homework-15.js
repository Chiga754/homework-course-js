(function () {
    console.log('***Домашнее задание на деструктуризацию***')
    ...
    console.log('Задание 1: ',func('a', 'b', 'c', 'd'));
    ...
    console.log('Задание 2: ',getInfo(organisation));
    ...
    const {
        ...
        friends : [{name: firstFriendsName = ''}],
    } = user;
    console.log('Задание 3:')
    console.log(userName, userBalance, userEmail);
    console.log(firstTag, lastTag);
    console.log(firstFriendsName);
